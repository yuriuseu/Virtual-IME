...
import yuriusu.virtual.inputmethod.latin.common.UnicodeSurrogate;
import yuriusu.virtual.inputmethod.latin.settings.SpacingAndPunctuations;
import yuriusu.virtual.inputmethod.latin.utils.CapsModeUtils;
import yuriusu.virtual.inputmethod.latin.utils.DebugLogUtils;
    ...
    public void commitText(final CharSequence text, final int newCursorPosition) {
        ...
        if (isConnected()) {
            ...
            for (final CharacterStyle span : spans) {
                ...
                // See yuriusu.virtual.inputmethod.latin.common.Constants.UnicodeSurrogate
